...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.print("Digite la distancia total del viaje en Km: ");
        distancia = leerTeclado.nextDouble();

        System.out.print("Digite el consumo de combustible del automóvil (litros por cada 100 km): ");
        consumoPor100Km = leerTeclado.nextDouble();

        System.out.print("Digite el precio por litro de combustible: ");
